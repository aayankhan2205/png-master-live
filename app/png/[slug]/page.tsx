  ...
  useEffect(() => {
    async function fetchImage() {
      try {
        ...
        // Get 4 related images (excluding the current one)
  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px', fontFamily: 'sans-serif', color: '#0f172a' }}>
      ...
      <style>{`
        ...
        /* IMAGE VIEWER (Smaller so no scrolling needed) */
      ...
      <div className="detail-grid">
        ...
        <div>
          ...
          {/* 4. RESIZE TOOL (Directly under download button) */}
          <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '16px', padding: '20px', marginBottom: '30px' }}>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              ...
              <button 
                ...
                disabled={downloading}
                style={{ backgroundColor: '#0f172a', color: '#fff', padding: '0 25px', borderRadius: '8px', fontWeight: 'bold', border: 'none', cursor: 'pointer', whiteSpace: 'nowrap' }}
              >
